validate_MAML = function(MAML, MAML_version=1.0){
  ...
  }else if(MAML_version == 1.1){
    schema = system.file('extdata', 'MAML_schema_v1p1.json', package = "MAML")
  }else if(MAML_version == 1.2){
    schema = system.file('extdata', 'MAML_schema_v1p2.json', package = "MAML")
  }
  ...
  MAML_json = gsub('"col_size": {}', '"array_size": null', MAML_json, fixed = T)
